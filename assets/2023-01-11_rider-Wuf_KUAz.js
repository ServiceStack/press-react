import{j as e}from"./index-BZTpaSnn.js";function t(s){const n={a:"a",code:"code",dev:"dev",div:"div",h3:"h3",h4:"h4",img:"img",p:"p",path:"path",pre:"pre",span:"span",strong:"strong",svg:"svg",...s.components};return e.jsxs(e.Fragment,{children:[e.jsxs(n.a,{href:"https://www.jetbrains.com/rider/",children:[`
`,e.jsx(n.img,{src:"https://raw.githubusercontent.com/ServiceStack/docs/master/docs/images/svg/rider.svg",className:"sm:float-left mr-8 w-24 h-24",style:{marginTop:"0"}})]}),`
`,e.jsxs(n.p,{children:[e.jsx(n.a,{href:"https://www.jetbrains.com/rider/",children:"JetBrains Rider"}),` is our recommended IDE for any C# + JavaScript development as it
...
`,e.jsxs(n.a,{href:"https://plugins.jetbrains.com/plugin/15321-tailwind-css",className:"text-2xl flex items-center",style:{textDecoration:"none"},children:[`
     `,e.jsx(n.svg,{className:"sm:float-left w-12 h-12",style:{margin:"0 .5rem 0 0"},xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",children:e.jsx(n.path,{fill:"#44a8b3",d:"M9 13.7q1.4-5.6 7-5.6c5.6 0 6.3 4.2 9.1 4.9q2.8.7 4.9-2.1q-1.4 5.6-7 5.6c-5.6 0-6.3-4.2-9.1-4.9q-2.8-.7-4.9 2.1Zm-7 8.4q1.4-5.6 7-5.6c5.6 0 6.3 4.2 9.1 4.9q2.8.7 4.9-2.1q-1.4 5.6-7 5.6c-5.6 0-6.3-4.2-9.1-4.9q-2.8-.7-4.9 2.1Z"})}),`
     `,e.jsx(n.span,{className:"",children:"Tailwind CSS Plugin"}),`
`]}),`
