...
`,e.jsx(n.files,{body:`/_videos
  ...
  /react
    ...
    bookings.md
    nextjs.md`}),`
`,e.jsx(n.p,{children:`This nice thing about this approach of marking up documentation is that the markdown content still remains in optimal
...
`,e.jsx(n.p,{children:`Ideally most of your Markdown content are able to just make use of the above features, but when even more interactivity
and richer functionality is required you're able to embed components directly in Markdown, but comes at the cost of
reduced portability.`}),`
`,e.jsx(n.h4,{children:e.jsx(n.a,{href:"/posts/markdown-components-in-react",children:"React Components in Markdown"})})]})}function r(s={}){const{wrapper:n}=s.components||{};return n?e.jsx(n,{...s,children:e.jsx(a,{...s})}):a(s)}export{r as default};
