...
`,e.jsx(s.div,{className:"remark-highlight",children:e.jsx(s.pre,{className:"language-html",children:e.jsxs(s.code,{className:"language-html",children:[e.jsxs(s.span,{className:"token tag",children:[e.jsxs(s.span,{className:"token tag",children:[e.jsx(s.span,{className:"token punctuation",children:"<"}),"article"]})," ",e.jsx(s.span,{className:"token attr-name",children:"class"}),e.jsxs(s.span,{className:"token attr-value",children:[e.jsx(s.span,{className:"token punctuation attr-equals",children:"="}),e.jsx(s.span,{className:"token punctuation",children:'"'}),"prose",e.jsx(s.span,{className:"token punctuation",children:'"'})]}),e.jsx(s.span,{className:"token punctuation",children:">"})]}),`
  `,e.jsxs(s.span,{className:"token tag",children:[e.jsxs(s.span,{className:"token tag",children:[e.jsx(s.span,{className:"token punctuation",children:"<"}),"h1"]}),e.jsx(s.span,{className:"token punctuation",children:">"})]}),"Garlic bread with cheese: What the science tells us",e.jsxs(s.span,{className:"token tag",children:[e.jsxs(s.span,{className:"token tag",children:[e.jsx(s.span,{className:"token punctuation",children:"</"}),"h1"]}),e.jsx(s.span,{className:"token punctuation",children:">"})]}),`
  `,e.jsxs(s.span,{className:"token tag",children:[e.jsxs(s.span,{className:"token tag",children:[e.jsx(s.span,{className:"token punctuation",children:"<"}),"p"]}),e.jsx(s.span,{className:"token punctuation",children:">"})]}),`
...
`,e.jsxs(s.span,{className:"token tag",children:[e.jsxs(s.span,{className:"token tag",children:[e.jsx(s.span,{className:"token punctuation",children:"</"}),"article"]}),e.jsx(s.span,{className:"token punctuation",children:">"})]}),`
`]})})}),`
...
`,e.jsx(s.hr,{}),`
`,e.jsx(s.h2,{children:"What to expect from here on out"}),`
...
`,e.jsx(s.h3,{children:"Typography should be easy"}),`
...
`]}),`
`,e.jsx(s.p,{children:"And that's the end of this section."})]})}function o(n={}){const{wrapper:s}=n.components||{};return s?e.jsx(s,{...n,children:e.jsx(t,{...n})}):t(n)}export{o as default};
