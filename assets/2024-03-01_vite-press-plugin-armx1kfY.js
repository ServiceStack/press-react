...
`,e.jsxs(n.p,{children:["A goal for ",e.jsx(n.strong,{children:"vite-press-plugin"}),` is to implement a suite of universal markdown-powered features that can be reused across
...
`,e.jsxs(n.p,{children:["The ",e.jsx(n.strong,{children:"vite-press-plugin"}),` currently powers the markdown features in the static Vite Vue and React templates which are
ideal for creating static websites, blogs, documentation and marketing websites that can be hosted FREE on `,e.jsx(n.a,{href:"https://pages.github.com",children:"GitHub Pages CDN"}),":"]}),`
`,e.jsx(n.h4,{children:"Static Vite Templates with vite-press-plugin"}),`
`,e.jsxs(n.ul,{children:[`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://press-vue.servicestack.net",children:"press-vue"})," - Vite Vue App"]}),`
`,e.jsxs(n.li,{children:[e.jsx(n.a,{href:"https://press-react.servicestack.net",children:"press-react"})," - Vite React App"]}),`
`]}),`
`,e.jsxs(n.div,{className:"not-prose mt-8 grid grid-cols-2 gap-4",children:[`
    `,e.jsxs(n.a,{className:"block group border dark:border-gray-800 hover:border-indigo-700 dark:hover:border-indigo-700 flex flex-col justify-between",href:"https://press-vue.servicestack.net",children:[`
        `,e.jsx(n.img,{className:"p-2",src:"https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/press-vue.png"}),`
        `,e.jsx(n.div,{className:"bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-semibold group-hover:bg-indigo-700 group-hover:text-white text-center py-2",children:"press-vue.servicestack.net"}),`
    `]}),`
    `,e.jsxs(n.a,{className:"block group border dark:border-gray-800 hover:border-indigo-700 dark:hover:border-indigo-700 flex flex-col justify-between",href:"https://press-react.servicestack.net",children:[`
        `,e.jsx(n.img,{className:"p-2",src:"https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/press-react.png"}),`
        `,e.jsx(n.div,{className:"bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-semibold group-hover:bg-indigo-700 group-hover:text-white text-center py-2",children:"press-react.servicestack.net"}),`
    `]}),`
`]}),`
...
`,e.jsx(n.p,{children:`When more capabilities are required and you want a .NET API backend to your Vite Vue or React SPA frontend,
...
`]}),`
`,e.jsxs(n.div,{className:"not-prose mt-8 grid grid-cols-2 gap-4",children:[`
    `,e.jsxs(n.a,{className:"block group border dark:border-gray-800 hover:border-indigo-700 dark:hover:border-indigo-700 flex flex-col justify-between",href:"https://vue-spa.web-templates.io",children:[`
        `,e.jsx(n.img,{className:"p-2",src:"https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/vue-spa.png"}),`
        `,e.jsx(n.div,{className:"bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-semibold group-hover:bg-indigo-700 group-hover:text-white text-center py-2",children:"vue-spa.web-templates.io"}),`
    `]}),`
    `,e.jsxs(n.a,{className:"block group border dark:border-gray-800 hover:border-indigo-700 dark:hover:border-indigo-700 flex flex-col justify-between",href:"https://react-spa.web-templates.io",children:[`
        `,e.jsx(n.img,{className:"p-2",src:"https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/react-spa.png"}),`
        `,e.jsx(n.div,{className:"bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-semibold group-hover:bg-indigo-700 group-hover:text-white text-center py-2",children:"react-spa.web-templates.io"}),`
    `]}),`
`]}),`
...
`]}),`
`,e.jsxs(n.div,{className:"not-prose mt-8 grid grid-cols-2 gap-4",children:[`
    `,e.jsxs(n.a,{className:"block group border dark:border-gray-800 hover:border-indigo-700 dark:hover:border-indigo-700 flex flex-col justify-between",href:"https://razor-ssg.web-templates.io",children:[`
        `,e.jsx(n.img,{className:"p-2",src:"https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/razor-ssg.png"}),`
        `,e.jsx(n.div,{className:"bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-semibold group-hover:bg-indigo-700 group-hover:text-white text-center py-2",children:"razor-ssg.web-templates.io"}),`
    `]}),`
    `,e.jsxs(n.a,{className:"block group border dark:border-gray-800 hover:border-indigo-700 dark:hover:border-indigo-700 flex flex-col justify-between",href:"https://blazor-vue.web-templates.io",children:[`
        `,e.jsx(n.img,{className:"p-2",src:"https://raw.githubusercontent.com/ServiceStack/Assets/master/csharp-templates/blazor-vue.png"}),`
        `,e.jsx(n.div,{className:"bg-gray-50 dark:bg-gray-800 text-gray-600 dark:text-gray-300 font-semibold group-hover:bg-indigo-700 group-hover:text-white text-center py-2",children:"blazor-vue.web-templates.io"}),`
    `]}),`
`]}),`
...
`,e.jsx(n.div,{className:"remark-highlight",children:e.jsx(n.pre,{className:"language-json",children:e.jsxs(n.code,{className:"language-json",children:[e.jsx(n.span,{className:"token punctuation",children:"{"}),`
  ...
  `,e.jsx(n.span,{className:"token property",children:'"publicBaseUrl"'}),e.jsx(n.span,{className:"token operator",children:":"})," ",e.jsx(n.span,{className:"token string",children:'"https://press-vue.servicestack.net"'}),e.jsx(n.span,{className:"token punctuation",children:","}),`
...
:::`})})}),`
`,e.jsx(n.h4,{children:"Output"}),`
`,e.jsx(n.sh,{children:e.jsx(n.p,{children:"npm run dev"})}),`
