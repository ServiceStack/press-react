 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(_,P){var $=_.length;_.push(P);e:for(;0<$;){var L=$-1>>>1,Q=_[L];if(0<o(Q,P))_[L]=P,_[$]=Q,$=L;else break e}}function n(_){return _.length===0?null:_[0]}function r(_){if(_.length===0)return null;var P=_[0],$=_.pop();if($!==P){_[0]=$;e:for(var L=0,Q=_.length,ze=Q>>>1;L<ze;){var Ie=2*(L+1)-1,nt=_[Ie],de=Ie+1,je=_[de];if(0>o(nt,$))de<Q&&0>o(je,nt)?(_[L]=je,_[de]=$,L=de):(_[L]=nt,_[Ie]=$,L=Ie);else if(de<Q&&0>o(je,$))_[L]=je,_[de]=$,L=de;else break e}}return P}function o(_,P){var $=_.sortIndex-P.sortIndex;return $!==0?$:_.id-P.id}if(typeof performance=="object"&&typeof performance.now=="function"){var i=performance;e.unstable_now=function(){return i.now()}}else{var s=Date,a=s.now();e.unstable_now=function(){return s.now()-a}}var l=[],c=[],d=1,u=null,h=3,v=!1,b=!1,y=!1,x=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,p=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function w(_){for(var P=n(c);P!==null;){if(P.callback===null)r(c);else if(P.startTime<=_)r(c),P.sortIndex=P.expirationTime,t(l,P);else break;P=n(c)}}function k(_){if(y=!1,w(_),!b)if(n(l)!==null)b=!0,J(S);else{var P=n(c);P!==null&&W(k,P.startTime-_)}}function S(_,P){b=!1,y&&(y=!1,m(T),T=-1),v=!0;var $=h;try{for(w(P),u=n(l);u!==null&&(!(u.expirationTime>P)||_&&!B());){var L=u.callback;if(typeof L=="function"){u.callback=null,h=u.priorityLevel;var Q=L(u.expirationTime<=P);P=e.unstable_now(),typeof Q=="function"?u.callback=Q:u===n(l)&&r(l),w(P)}else r(l);u=n(l)}if(u!==null)var ze=!0;else{var Ie=n(c);Ie!==null&&W(k,Ie.startTime-P),ze=!1}return ze}finally{u=null,h=$,v=!1}}var C=!1,E=null,T=-1,R=5,N=-1;function B(){return!(e.unstable_now()-N<R)}function z(){if(E!==null){var _=e.unstable_now();N=_;var P=!0;try{P=E(!0,_)}finally{P?X():(C=!1,E=null)}}else C=!1}var X;if(typeof p=="function")X=function(){p(z)};else if(typeof MessageChannel<"u"){var F=new MessageChannel,V=F.port2;F.port1.onmessage=z,X=function(){V.postMessage(null)}}else X=function(){x(z,0)};function J(_){E=_,C||(C=!0,X())}function W(_,P){T=x(function(){_(e.unstable_now())},P)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(_){_.callback=null},e.unstable_continueExecution=function(){b||v||(b=!0,J(S))},e.unstable_forceFrameRate=function(_){0>_||125<_?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):R=0<_?Math.floor(1e3/_):5},e.unstable_getCurrentPriorityLevel=function(){return h},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(_){switch(h){case 1:case 2:case 3:var P=3;break;default:P=h}var $=h;h=P;try{return _()}finally{h=$}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(_,P){switch(_){case 1:case 2:case 3:case 4:case 5:break;default:_=3}var $=h;h=_;try{return P()}finally{h=$}},e.unstable_scheduleCallback=function(_,P,$){var L=e.unstable_now();switch(typeof $=="object"&&$!==null?($=$.delay,$=typeof $=="number"&&0<$?L+$:L):$=L,_){case 1:var Q=-1;break;case 2:Q=250;break;case 5:Q=1073741823;break;case 4:Q=1e4;break;default:Q=5e3}return Q=$+Q,_={id:d++,callback:P,priorityLevel:_,startTime:$,expirationTime:Q,sortIndex:-1},$>L?(_.sortIndex=$,t(c,_),n(l)===null&&_===n(c)&&(y?(m(T),T=-1):y=!0,W(k,$-L))):(_.sortIndex=Q,t(l,_),b||v||(b=!0,J(S))),_},e.unstable_shouldYield=B,e.unstable_wrapCallback=function(_){var P=h;return function(){var $=h;h=P;try{return _.apply(this,arguments)}finally{h=$}}}})(Zf);Xf.exports=Zf;var Iv=Xf.exports;/**
 * @license React
...
#### [React Components in Markdown](/posts/markdown-components-in-react)`,date:"2024-03-01",tags:["docs","markdown"],wordCount:2017,lineCount:490,minutesToRead:9,title:"Vite Press Plugin",summary:"Introducing the Vite Press Plugin for Vite Vue & React Apps",author:"Lucy Bates",image:"https://images.unsplash.com/photo-1524668951403-d44b28200ce0?crop=entropy&fit=crop&h=1000&w=2000",url:"/posts/vite-press-plugin"},{slug:"markdown-components-in-react",path:"src/_posts/2024-02-28_markdown-components-in-react.mdx",fileName:"markdown-components-in-react.mdx",content:`import GettingStarted from "@/components/GettingStarted"
...
}} />`,date:"2024-02-28",tags:["docs","markdown"],wordCount:974,lineCount:299,minutesToRead:4,title:"React Components in Markdown",summary:"How to reference and Import React Components in Markdown",author:"Lucy Bates",image:"https://images.unsplash.com/photo-1700427296131-0cc4c4610fc6?crop=entropy&fit=crop&h=1000&w=2000",url:"/posts/markdown-components-in-react"},{slug:"net8-best-blazor",path:"src/_posts/2023-11-22_net8-best-blazor.md",fileName:"net8-best-blazor.md",content:`<script setup>
...
complex animations that would otherwise be time-consuming and challenging to build.`,date:"2023-03-08",tags:[],wordCount:86,lineCount:7,minutesToRead:0,title:"Animaginary",url:"/blog",image:"/img/whatsnew/animaginary.svg",group:"Animaginary"}]},components:{blog:{"vite-press-plugin":()=>H(()=>import("./2024-03-01_vite-press-plugin-4yW2jbXC.js"),__vite__mapDeps([])),"markdown-components-in-react":()=>H(()=>import("./2024-02-28_markdown-components-in-react-Dzv8quXI.js"),__vite__mapDeps([8,9,10])),"net8-best-blazor":()=>H(()=>import("./2023-11-22_net8-best-blazor-Bk5CgpI0.js"),__vite__mapDeps([])),"net8-blazor-template":()=>H(()=>import("./2023-11-20_net8-blazor-template-B1Biqd35.js"),__vite__mapDeps([])),"razor-ssg-new-blog-features":()=>H(()=>import("./2023-08-23_razor-ssg-new-blog-features-B0vN0Wjl.js"),__vite__mapDeps([11,10])),"razor-ssg":()=>H(()=>import("./2023-03-30_razor-ssg-CyitKwds.js"),__vite__mapDeps([])),javascript:()=>H(()=>import("./2023-02-01_javascript-BJxaRBP7.js"),__vite__mapDeps([12,9])),start:()=>H(()=>import("./2023-01-21_start-8x8-fGis.js"),__vite__mapDeps([])),rider:()=>H(()=>import("./2023-01-11_rider-DUCn_N42.js"),__vite__mapDeps([])),vs:()=>H(()=>import("./2023-01-10_vs-DUVomcuo.js"),__vite__mapDeps([])),deploy:()=>H(()=>import("./2023-01-01_deploy-CCJGXhJf.js"),__vite__mapDeps([])),typography:()=>H(()=>import("./2022-12-31_typography-BDArTMAc.js"),__vite__mapDeps([])),"hetzner-cloud":()=>H(()=>import("./2022-09-06_hetzner-cloud-BVBviRpe.js"),__vite__mapDeps([]))},videos:{react:{nextjs:()=>H(()=>import("./nextjs-Dsombyge.js"),__vite__mapDeps([])),"autoquery-bookings":()=>H(()=>import("./autoquery-bookings-CGRU8ebn.js"),__vite__mapDeps([])),"autogen-locode":()=>H(()=>import("./autogen-locode-CG02bjUA.js"),__vite__mapDeps([])),modern:()=>H(()=>import("./modern-C3qcbZ67.js"),__vite__mapDeps([])),"razor-ssg":()=>H(()=>import("./razor-ssg-DfZBr194.js"),__vite__mapDeps([]))}},whatsNew:{"2023-03-28_Planetaria":{feature1:()=>H(()=>import("./feature1-BpWRw1nm.js"),__vite__mapDeps([]))},"2023-03-18_OpenShuttle":{feature1:()=>H(()=>import("./feature1-BUbVWTD1.js"),__vite__mapDeps([]))},"2023-03-08_Animaginary":{feature1:()=>H(()=>import("./feature1-DkWrbvd8.js"),__vite__mapDeps([]))}},includes:{"features.md":()=>H(()=>import("./features-DwgDxOu7.js"),__vite__mapDeps([])),"vite-press-plugin/folder-features.md":()=>H(()=>import("./folder-features-C9EluOS6.js"),__vite__mapDeps([]))}}};function aC(){return g.jsx(f.Suspense,{fallback:g.jsx(zg,{children:g.jsx(I3,{className:"p-4"})}),children:g.jsx(Jk,{defaultTheme:"light",storageKey:"color-scheme",children:g.jsx($r.Provider,{value:sC,children:fw(iC)})})})}function lC(){const{pathname:e}=_r();return f.useEffect(()=>{window.scrollTo(0,0)},[e]),null}const cC=tv(document.getElementById("root"));cC.render(g.jsx(f.StrictMode,{children:g.jsxs($w,{children:[g.jsx(lC,{}),g.jsx(aC,{})]})}));export{Ho as $,Hl as A,km as B,Nx as C,le as D,wC as E,tS as F,j3 as G,wu as H,U3 as I,Fl as J,zg as L,NS as M,$r as P,Ow as S,bC as T,V3 as V,D as _,er as a,ob as b,G3 as c,ib as d,$g as e,eS as f,rb as g,W3 as h,pC as i,g as j,hC as k,fC as l,Vo as m,Qo as n,Ue as o,Jx as p,G as q,f as r,yb as s,wb as t,dC as u,mb as v,et as w,M2 as x,br as y,Sm as z};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/about-Bb9YQeVr.js","assets/LayoutArticle-NVQ3GhYH.js","assets/privacy-i3HLOj9z.js","assets/index-Cq4Z14fy.js","assets/BlogPosts-CQ-x16k5.js","assets/_name_-BfwBhDWx.js","assets/_tag_-evFa6jNv.js","assets/_year_-C3biH13o.js","assets/2024-02-28_markdown-components-in-react-Dzv8quXI.js","assets/HelloApi-DRwDHM76.js","assets/ChartJs-CM2D_5b9.js","assets/2023-08-23_razor-ssg-new-blog-features-B0vN0Wjl.js","assets/2023-02-01_javascript-BJxaRBP7.js"]
  }
