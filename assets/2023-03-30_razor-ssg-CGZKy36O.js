import{j as n}from"./index-BZTpaSnn.js";function a(e){const s={a:"a",code:"code",div:"div","getting-started":"getting-started",h2:"h2",h3:"h3",h4:"h4",iframe:"iframe",img:"img",li:"li",ol:"ol",p:"p",pre:"pre",sh:"sh",span:"span",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...e.components},t=s["getting-started"];return n.jsxs(n.Fragment,{children:[n.jsxs(s.p,{children:["Razor SSG is a Razor Pages powered Markdown alternative to ",n.jsx(s.a,{href:"https://jekyllrb.com/",children:"Ruby's Jekyll"}),` &
...
`,n.jsx(s.iframe,{className:"youtube",src:"https://www.youtube.com/embed/MRQMBrXi5Sc",frameBorder:"0",allow:"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture",allowFullScreen:!0}),`
...
`]})})}),`
`,n.jsxs(s.div,{className:"py-8 not-prose text-base flex justify-center",children:[`
  `,n.jsx(t,{template:"razor-ssg"}),`
`]}),`
...
`,n.jsx(s.h3,{children:n.jsx(s.a,{href:"https://servicestack.net/ideas",children:"https://servicestack.net/ideas"})})]})}function i(e={}){const{wrapper:s}=e.components||{};return s?n.jsx(s,{...e,children:n.jsx(a,{...e})}):a(e)}export{i as default};
